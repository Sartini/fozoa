...
//essa funcao reescreve o primeiro paragrafo com a class lead, retirei pois nao será necessario reescrever
//primeiro paragrafo
...
function theme_js(){
 ...
 // wp_register_script('jquery', get_template_directory_uri().'/library/js/libs/jquery-1.7.1.min.js', false, '1.7.1');
  ...
  wp_register_script('backbonejs', get_template_directory_uri().'/js/vendors/backbone.js');
  ...
  //backbone files
  wp_register_script('backbone-routes', get_template_directory_uri().'/js/routes/app.js');
  wp_register_script('backbone-views-app', get_template_directory_uri().'/js/views/app.js');
  wp_register_script('backbone-views-home', get_template_directory_uri().'/js/views/home.js');
  wp_register_script('backbone-views-page', get_template_directory_uri().'/js/views/page.js');

  // wp_enqueue_script('less', array(''), '1.3.0', true);
  wp_enqueue_script('jquery');
    //backbone
  wp_enqueue_script('underscorejs', array(''), '1.3', true);
  wp_enqueue_script('backbonejs', array(''), '1.3', true);
  ...
  wp_enqueue_script('backbone-routes', array('jQuery'), '1.1', true);
  wp_enqueue_script('backbone-views-app', array('jQuery'), '1.1', true);
  wp_enqueue_script('backbone-views-home', array('jQuery'), '1.1', true);
  wp_enqueue_script('backbone-views-page', array('jQuery'), '1.1', true);
}
